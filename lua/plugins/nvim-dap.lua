            ...
            dap.configurations.cpp = {
                ...
                },
                {
                    ...
                    setupCommands = {
                        ...
                        { text = "set detach-on-fork off", description = "Do not detach other process", ignoreFailures = false },
                        { text = "set breakpoint pending on", description="allow breakpoints before symbols loaded", ignoreFailures = false },
